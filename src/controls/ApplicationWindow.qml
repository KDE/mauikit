...
Window
{
  ...
  minimumHeight: Maui.Handy.isMobile ? undefined : Math.min(600, Screen.desktopAvailableHeight)
  minimumWidth: Maui.Handy.isMobile ? undefined : Math.min(400, Screen.desktopAvailableWidth)
