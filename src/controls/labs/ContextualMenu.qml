...
T.Menu
{
    ...
    width: control.responsive ? window().width :  Math.min(window().width, Math.max(control.parent.width, Math.max(250, contentItem ? contentItem.implicitWidth + leftPadding + rightPadding : 0)))
