...
/**
 @brief A button styled to be used "floating" above other elements.
   ...
   <a href="https://doc.qt.io/qt-6/qml-qtquick-controls-toolbar.html">This controls inherits from QQC2 ToolBar, to checkout its inherited properties refer to the Qt Docs.</a>
