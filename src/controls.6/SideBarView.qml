...
/**
 @brief A view with a collapsable sidebar.
 
 The SideBarView is a convinient way for organizing the application contents into view alongside with a side-bar, which can be resized, collased, hidden and tweaked further. This control adapts to small screen spaces.
...
The SideBarView is divided into two sections, the sidebar container and the main contents area.
 ...
 The default behaviour of the main content is be to shifted/moved when the sidebar being collapsed is expanded.
  ...
  @image html SideBarView/sidebar_collapsed.png
  @note The sidebar is collapsed and expanded, shifting the main area content.
